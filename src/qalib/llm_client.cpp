...
namespace QA::Core
{
LLMClient::LLMClient(const std::string_view model,
...
LLMClient::no_streaming_request(const std::vector<Message>& messages)
{
...
std::optional<CommonChatResponse>
LLMClient::streaming_request(const std::vector<Message>& messages,
